"""
	...
	Usage python client_run.py [2_20|2_40|5_20|5_40|5_80]
...
def main(run, band, variant):
	...
	with open("/home/susan/Desktop/BTP/Client/log.txt","a+") as f:
		f.write("Start " + str(run) + "\n")

	print "Start ", run

	f_out = open("/home/susan/Desktop/BTP/Client/tcpdumpSTDOUT", "w")
	f_err = open("/home/susan/Desktop/BTP/Client/tcpdumpSTDERR", "w")

	cmd = "sudo tcpdump -n -s0 -w /home/susan/Desktop/BTP/Client/" + band + "/" + variant + "/trace" + str(run) +".pcap -i wlan2"
	ip = "192.168.1.2"
	port = "3300"
...
if __name__ == '__main__':
	...
	band = sys.argv[1]
	directory = "/home/susan/Desktop/BTP/Client/" + band + "/"
	...
	for variant in tcp_varinat:
		...
		directory = "/home/susan/Desktop/BTP/Client/" + band + "/" + variant + "/"
